...
const List = ({
    ...
    return (
        ...
        >
            ...
            <div
                className="grid h-52 max-h-52 min-h-52 w-full grid-rows-4 gap-3 overflow-x-auto overflow-y-hidden border-t border-neutral-500/50 p-3 pb-0 lg:hidden dark:border-neutral-500/30"
